package com.trainingproject.trainingweb;
...
public class TicketInfo {
	...
	public String recieveTicketinfo
	(@PathParam("ticket_type") String type,
	...
	}// how to send the data /webapi/st/query?type=movie&name=vhh
	...
	public String insertMatrix(@MatrixParam("type") String type,@MatrixParam("name") String name)
	{
		...
		return "{\"hello\",\"success\"}";
			...
			return "{\"hello\",\"fail\"}";
	}// how to send the data /webapi/info/matrix;type=movie;name=vhh
